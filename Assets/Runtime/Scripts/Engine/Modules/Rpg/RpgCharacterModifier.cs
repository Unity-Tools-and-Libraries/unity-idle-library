...
namespace io.github.thisisnozaku.idle.framework.Engine.Modules.Rpg
{
    ...
    public abstract class RpgCharacterModifier : EntityModifier<RpgCharacter>
    {
        ...
        public RpgCharacterModifier(IdleEngine engine, double id, string description, Dictionary<string, Tuple<string, string>> modifications, Dictionary<string, List<string>> events = null) : base(engine, id, modifications)
        {
