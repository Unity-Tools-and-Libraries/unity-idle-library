...
public class ClampedValueTest
{
    ...
    {
        Assert.AreEqual(BigDouble.Floor(0), tooLow.GetAsNumber(null));
    }

    [Test]
    public void returnMaximumWhenValueIsLessThan()
    {
        Assert.AreEqual(BigDouble.Floor(1), tooHigh.GetAsNumber(null));
    }

    [Test]
    public void returnActualValueWhenInBetween()
    {
        Assert.AreEqual(BigDouble.Floor(1), baseValue.GetAsNumber(null));
    }
}
